# -------------------------------------------------------------------------
# APPolyline2 / APCurvilinearPolyline2 (<: APCurve{2,T}): open curves made
# of consecutive sides -- the open counterparts of APStraightNgon/
# APCurvilinearNgon2 (which always close back to their own first vertex).
# -------------------------------------------------------------------------

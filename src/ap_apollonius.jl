...
# APPoint/APLine/APCircle2. `_solve_quadratic` is untyped (utils.jl) and
# works for free; `_dedupe_circles`/`_exclude_given` have APCircle2 methods
# in ap_tangency.jl.
# -------------------------------------------------------------------------
...
# -------------------------------------------------------------------------
# `interstices(c1, c2, c3)`: builds an `APInterstice2` from 3 mutually

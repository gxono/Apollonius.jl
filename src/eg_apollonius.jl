...
# EGPoint/EGLine/EGCircle2. Formula bodies are unchanged from the
# Point2-based originals; `_solve_quadratic` is already untyped (utils.jl)
# and works for free, and `_dedupe_circles`/`_exclude_given` already have
# EGCircle2 methods (eg_tangency.jl).
# -------------------------------------------------------------------------
...
# -------------------------------------------------------------------------
# interstices(c1, c2, c3): deferred from Phase 5 (eg_curved_region.jl),
# which needed exactly the `tangent_circles` (CCC Apollonius) just ported
# above. Mechanical port of interstice.jl's own `interstices` and its
# private helpers onto EGCircle2/EGCircularArc2/EGInterstice2.
# -------------------------------------------------------------------------

...
# rather than being tied to any one point/curve type. These used to live
# in the old Point2-based primitives.jl/vectors.jl/predicates.jl/
# triangle.jl (deleted in Phase 8) — kept here now as the single shared
# home their own doc comments already described them as having.
# -------------------------------------------------------------------------

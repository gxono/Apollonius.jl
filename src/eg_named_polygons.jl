# -------------------------------------------------------------------------
# Phase 7 (continued): mechanical port of named_polygons.jl onto
# EGPoint/EGQuadrilateral/EGStraightNgon. Formula bodies are unchanged
# from the Point2-based originals.
# -------------------------------------------------------------------------

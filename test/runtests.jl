...
@testset "EuclideanGeometry.jl" begin
    ...
    # .claude/plans/structured-wibbling-wigderson.md): EGPoint/EGVector,
    # built from scratch, not yet used by anything else in the package.
    @testset "EGPoint / EGVector (Phase 1 foundation)" begin
    ...
    @testset "EGSegment / EGLine / EGRay / EGBoundingBox (Phase 2)" begin
    ...
    # generically on EGPolygon.
    @testset "EGTriangle / EGQuadrilateral / EGStraightNgon (Phase 3)" begin
    ...
    # Phase 4: EGCircle2/EGEllipse2/EGParabola2/EGHyperbola2 (<: EGConic2)
    # and EGCircularArc2/EGEllipticArc2/EGParabolicArc2/EGHyperbolicArc2
    # (<: EGConicArc2, the last three brand new).
    @testset "EGConic2 / EGConicArc2 (Phase 4)" begin
    ...
    # sides-based area/perimeter from eg_polygon.jl. EGAnnularSector2,
    # EGCurvilinearTriangle2 and EGCurvilinearQuadrilateral2 are brand new.
    @testset "EGPolygon curved regions (Phase 5)" begin
    ...
    # Phase 6: EGAngle2/EGHalfPlane2/EGStrip2, all <: EGSet (unbounded
    # regions of the plane).
    @testset "EGSet unbounded regions (Phase 6)" begin
    ...
    # Phase 7 (start): EGAffineMap (<: EGTransform), callable on every
    # EG-typed shape defined in Phases 1-6.
    @testset "EGAffineMap (Phase 7)" begin
    ...
    # Phase 7 (continued): mechanical port of predicates.jl onto EGPoint/
    # EGLine/EGSegment/EGCircle2/EGTriangle.
    @testset "EG predicates (Phase 7)" begin
    ...
    @testset "EG intersections (Phase 7)" begin
        ...
        # deferred from Phase 3, now unblocked by intersection(::EGLine, ::EGLine)
    ...
    # Phase 7 (continued): mechanical port of constructions.jl and
    # tangency.jl onto EGPoint/EGLine/EGCircle2.
    @testset "EG constructions and tangency (Phase 7)" begin
    ...
    # Phase 7 (continued): mechanical port of radical_axis.jl and
    # inversion.jl onto EGPoint/EGLine/EGSegment/EGCircle2/EGCircularArc2.
    @testset "EG radical axis and inversion (Phase 7)" begin
        c1 = EGCircle2(EGPoint(0.0, 0.0), 5.0)
        c2 = EGCircle2(EGPoint(8.0, 0.0), 5.0)
    ...
    # EGPoint/EGLine/EGCircle2, plus interstices(::EGCircle2, ...)
    # (deferred from Phase 5 — needed exactly this CCC Apollonius solver).
    @testset "EG Apollonius and interstices (Phase 7)" begin
    ...
    @testset "EG named polygons, triangle-on-segment, conic fit (Phase 7)" begin
    ...
    @testset "EGQuadrilateral" begin
        ...
        # already unified across the whole EGPolygon family (Phase 3)
    ...
    @testset "tkz-elements gap analysis round 2" begin
    ...
    @testset "polar_point" begin
        # no zero-argument default for `center` here (unlike the old
        # Point2-based polar_point) — see rotation_map's docstring for why

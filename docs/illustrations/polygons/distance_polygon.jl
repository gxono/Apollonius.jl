...
sethue("white"); path([inner, outer], action=:fillpreserve); sethue(julia_blue); strokepath()
sethue("white"); path([foot_in, foot_out], action=:fillpreserve); sethue(julia_purple); strokepath()
end)
